				...
				if (needChunkLoadingCode(chunk)) {
					...
					return Template.asString([
						...
						Template.indent([
							...
							"if (trustedTypesPolicy === undefined && (window.trustedTypes || window.TrustedTypes)) {",
							Template.indent([
								`trustedTypesPolicy = (window.trustedTypes || window.TrustedTypes).createPolicy(${JSON.stringify(
